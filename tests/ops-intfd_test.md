...
4. Asociante interface 1 with interface lag 1
5. Create interface 2
6. Asociante interface 2 with interface lag 1
7. Create interface 3
8. Asociante interface 3 with interface lag 1
8. Set **no shutdown** in lag 1
8. Use show running-config interface
