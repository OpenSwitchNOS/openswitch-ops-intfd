...
static char *interface_statistics_keys[] = {
    ...
    "rx_dropped", "rx_frame_err", "rx_over_err", "rx_crc_err",
    "rx_errors",  "tx_dropped",   "collisions",  "tx_errors"};
