...
void ifDescr_custom_function(const struct ovsdb_idl *idl,
                             const struct ovsrec_interface *interface_row,
...
void ifLastChange_custom_function(const struct ovsdb_idl *idl,
                                  const struct ovsrec_interface *interface_row,
...
void ifOutQLen_custom_function(const struct ovsdb_idl *idl,
                               const struct ovsrec_interface *interface_row,
                               long *ifOutQLen_val_ptr);

void ifSpecific_custom_function(const struct ovsdb_idl *idl,
                                const struct ovsrec_interface *interface_row,
...
void ifHCInOctets_custom_function(const struct ovsdb_idl *idl,
                                  const struct ovsrec_interface *interface_row,
...
void ifHCOutOctets_custom_function(const struct ovsdb_idl *idl,
                                   const struct ovsrec_interface *interface_row,
...
void ifAlias_custom_function(const struct ovsdb_idl *idl,
                             const struct ovsrec_interface *interface_row,
