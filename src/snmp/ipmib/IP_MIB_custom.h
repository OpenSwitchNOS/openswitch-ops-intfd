...
unsigned long long
ipIfStatsInReceives_custom_function_v4(const struct ovsrec_interface *int_row);

unsigned long long
ipIfStatsInOctets_custom_function_v4(const struct ovsrec_interface *int_row);

unsigned long long ipIfStatsOutTransmits_custom_function_v4(
    const struct ovsrec_interface *int_row);

unsigned long long
ipIfStatsOutOctets_custom_function_v4(const struct ovsrec_interface *int_row);

unsigned long long
ipIfStatsInMcastPkts_custom_function_v4(const struct ovsrec_interface *int_row);
...
unsigned long long
ipIfStatsInReceives_custom_function_v6(const struct ovsrec_interface *int_row);

unsigned long long
ipIfStatsInOctets_custom_function_v6(const struct ovsrec_interface *int_row);

unsigned long long ipIfStatsOutTransmits_custom_function_v6(
    const struct ovsrec_interface *int_row);

unsigned long long
ipIfStatsOutOctets_custom_function_v6(const struct ovsrec_interface *int_row);

unsigned long long
ipIfStatsInMcastPkts_custom_function_v6(const struct ovsrec_interface *int_row);
