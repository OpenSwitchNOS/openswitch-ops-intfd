...
unsigned long long ipIfStatsInOctets_custom_function_v4(
    ...
    int i = 0;
    for (i = 0; i < interface_row->n_statistics; i++) {
        if (strcmp(*(interface_row->key_statistics + i), "ipv4_uc_rx_bytes") ==
            0) {
            ret += *(interface_row->value_statistics);
        }
        if (strcmp(*(interface_row->key_statistics + i), "ipv4_mc_rx_bytes") ==
            0) {
            ret += *(interface_row->value_statistics);
        }
    }
...
unsigned long long ipIfStatsOutOctets_custom_function_v4(
    ...
    int i = 0;
    for (i = 0; i < interface_row->n_statistics; i++) {
        if (strcmp(*(interface_row->key_statistics + i), "ipv4_uc_tx_bytes") ==
            0) {
            ret += *(interface_row->value_statistics);
        }
        if (strcmp(*(interface_row->key_statistics + i), "ipv4_mc_tx_bytes") ==
            0) {
            ret += *(interface_row->value_statistics);
        }
    }
...
unsigned long long ipIfStatsInOctets_custom_function_v6(
    ...
    int i = 0;
    for (i = 0; i < interface_row->n_statistics; i++) {
        if (strcmp(*(interface_row->key_statistics + i), "ipv6_uc_rx_bytes") ==
            0) {
            ret += *(interface_row->value_statistics);
        }
        if (strcmp(*(interface_row->key_statistics + i), "ipv6_mc_rx_bytes") ==
            0) {
            ret += *(interface_row->value_statistics);
        }
    }
...
unsigned long long ipIfStatsOutMcastOctets_custom_function_v6(
    ...
    int i = 0;
    for (i = 0; i < interface_row->n_statistics; i++) {
        if (strcmp(*(interface_row->key_statistics + i), "ipv6_mc_tx_bytes") ==
            0) {
            ret += *(interface_row->value_statistics);
        }
    }
