...
#include "ovsdb-idl.h"
#include "intf_vty.h"
#include "vtysh/vlan_utils.h"
#include "vtysh/lacp_utils.h"
//#include "lacp_vty.h"
#include "smap.h"
...
void cli_pre_init(void)
{
    ...
    /* installing interface node */
    install_node (&interface_node, NULL);
    vtysh_install_default (INTERFACE_NODE);
}


/* Initialize interface cli element.
 */
void cli_post_init(void)
{
    ...
    /* Initialize intf context show running client callback function. */
