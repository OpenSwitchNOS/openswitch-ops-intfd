...
DEFUN (cli_intf_show_interface_ifname,
        cli_intf_show_interface_ifname_cmd,
...
DEFUN (cli_intf_show_interface_ifname_br,
        cli_intf_show_interface_ifname_br_cmd,
...
void cli_post_init(void)
{
    ...
    install_element (ENABLE_NODE, &cli_intf_show_interface_ifname_cmd);
    install_element (ENABLE_NODE, &cli_intf_show_interface_ifname_br_cmd);
